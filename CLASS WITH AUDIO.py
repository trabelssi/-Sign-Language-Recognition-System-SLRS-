"""Real-Time Sign Language Recognition System with Audio Feedback

This script performs real-time sign language gesture recognition using a webcam feed.
It detects 6 hand gestures (call, mute, peace, ok, stop, palm) and provides audio feedback
via text-to-speech when a gesture is detected with high confidence (>90%).
...
- Text-to-speech announcements for detected gestures
- Real-time probability display
- FPS monitoring

Usage:
    python realtime_recognition_with_audio.py
