"""
Sign Language Recognition System - Model Training Script

Author: Mohamed Amine Trabelsi
GitHub: https://github.com/trabelssi
LinkedIn: https://www.linkedin.com/in/trabelsi-mohamed-amine/
Project: PFE - Graduation Project

This script trains a deep learning model for sign language gesture recognition using
transfer learning with ResNet50V2 architecture. The model is trained to classify
5 different hand gestures used in sign language.

Training Approach:
- Transfer Learning with ResNet50V2 pre-trained on ImageNet
- Fine-tuning for sign language gesture classification
- Data augmentation for improved generalization

Dataset Structure:
- 6 classes with 1,380 training images per class
- 200 test images per class
- 350 validation images per class
- Total: 6,900 high-quality labeled images

Technical Stack:
- TensorFlow/Keras for deep learning
- ResNet50V2 as the base model (EfficientNet was tested but gave unsatisfactory results)
- Adam/RMSprop optimizers
- ImageDataGenerator for data augmentation

Platform:
- Designed for Google Colab platform
- GPU acceleration recommended for faster training

Usage:
    Run this script in Google Colab or any Python environment with the required libraries
    and dataset properly configured.
"""
