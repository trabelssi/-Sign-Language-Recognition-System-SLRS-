"""Real-Time Sign Language Recognition System (Silent Mode)

This script performs real-time sign language gesture recognition using a webcam feed
without audio feedback. Optimized for performance on resource-constrained devices
like Raspberry Pi and laptops.

Author: Mohamed Amine Trabelsi
GitHub: https://github.com/trabelssi
LinkedIn: https://www.linkedin.com/in/trabelsi-mohamed-amine/
Project: PFE - Graduation Project (Sign Language Recognition System)
...
Features:
- Live webcam feed processing at 320x240 resolution
- GPU-accelerated inference (with CPU fallback)
- Real-time probability display on screen
- FPS monitoring
- Lightweight execution without audio processing

Gestures Detected:
- call, mute, peace, ok, stop, palm (6 classes)

Usage:
    python realtime_recognition_silent.py
